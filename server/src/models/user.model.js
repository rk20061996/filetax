...
const { createNewUser: createNewUserQuery, findUserByEmail: findUserByEmailQuery,checkConfirmToken:checkConfirmToken,updateConfirmToken:updateConfirmToken } = require('../database/queries');
