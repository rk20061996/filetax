                        ...
                        <div className="col-sm-12 col-md-8">
                            <div className="bannerContent">
                                ...
                                <a onClick={() => {
                                    ...
                                    className="btn btn-primary">Let's connect<span class="material-symbols-outlined">
                                        arrow_right_alt
                                    </span></a>
                            </div>
                        </div>
                    ...
                    <div className="row">
                        <div className="col-sm-6 col-md-6 col-lg-3">
                            <div className="item">
                                ...
                                <p>Our expert advisors provide strategic guidance to optimize your financial decisions and minimize your tax liability.<a onClick={() => {
                                    // localStorage.removeItem('token');
                        ...
                        <div className="col-sm-6 col-md-6 col-lg-3">
                            <div className="item">
                                ...
                                <p>Student Tax Filing: We specialize in assisting students with their tax returns, ensuring they take advantage of applicable deductions and credits.<a onClick={() => {
                                    // localStorage.removeItem('token');
                                    navigate('/student-tax')
                                }}>Read more</a></p>
                            </div>
                        </div>
                        <div className="col-sm-6 col-md-6 col-lg-3">
                            <div className="item">
                                ...
                                <p>Our team ensures accurate and timely filing of your tax returns, simplifying the process for individuals and businesses.<a onClick={() => {
                                    // localStorage.removeItem('token');
                                    navigate('/tax-return')
                                }}>Read more</a></p>
                            </div>
                        ...
                        <div className="col-sm-6 col-md-6 col-lg-3">
                            <div className="item">
                                ...
                                <p>ITIN Processing: We help individuals obtain an Individual Taxpayer Identification Number (ITIN) for tax compliance.<a onClick={() => {
                                    // localStorage.removeItem('token');
                                    navigate('/itin-processing')
                                }}>Read more</a></p>
                            </div>
                        </div>
                        <div className="col-sm-6 col-md-6 col-lg-3">
                            <div className="item">
                                ...
                                <p>Ensure compliance with FBAR reporting requirements for foreign financial accounts.<a onClick={() => {
                                    // localStorage.removeItem('token');
                                    navigate('/fbar')
                                }}>Read more</a></p>
                            </div>
                        ...
                        <div className="col-sm-6 col-md-6 col-lg-3">
                            <div className="item">
                                ...
                                <p>We offer expertise in FATCA reporting, helping you navigate international tax regulations.<a onClick={() => {
                                    // localStorage.removeItem('token');
                                    navigate('/fatca')
                                }}>Read more</a></p>
                            </div>
                        ...
                        <div className="col-sm-6 col-md-6 col-lg-3">
                            <div className="item">
                                ...
                                <p>Our tax experts provide customized solutions, addressing complex tax issues and planning for your financial future.<a onClick={() => {
                                    // localStorage.removeItem('token');
                                    navigate('/tax-consulting')
                                }}>Read more</a></p>
                            </div>
                        </div>
                        <div className="col-sm-6 col-md-6 col-lg-3">
                            <div className="item">
                                ...
                                <h4>Tax Extension</h4>
                                <p> File for a tax extension with confidence, and avoid penalties by trusting our experienced professionals. <a onClick={() => {
                                    // localStorage.removeItem('token');
                                    navigate('/tax-extension')
                                }}>Read more</a></p>
                            </div>
                        </div>
                    </div>
