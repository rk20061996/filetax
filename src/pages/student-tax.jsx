            ...
            <section className="aboutSection listWrap">
                <div className="container">
                    <div className="row">
                        ...
                        <p>College brings with it many adult responsibilities you may have never had to encounter; doing your own laundry, <br /> paying all your own bills, and for many, completing a tax return for the first time.</p><br />
                        <p>Filing taxes as a student, especially if it’s the first time you have had to file, can be a daunting task. <br /> I hope this article can provide some tax tips for students in college that may feel intimidated by the process.</p>
                        </div>
                        ...
                        <div className="col-sm-12 col-md-5">
                            <img src="images/studenttax.jpg" alt="" className="serviceImg w-100" />
                        </div>
                    </div>
                </div>
            </section>
