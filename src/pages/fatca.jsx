...
function Fatca(props) {
    return (
        <>
            ...
            <section className="fbarWrap fatcaWrap">
                <div className="container">
                    <div className="row">
                        <div className="col-sm-12 col-md-7">
                            <p>The Foreign Account Tax Compliance Act (FATCA)is an development in US. efforts to combat tax evasion by US. persons holding accounts and other financial assets offshore.This FATCA requirement is in addition to the long-standing requirement to report foreign financial accounts on FinCEN Form 114. FATCA will also require certain foreign financial institutions to report directly to the IRS information about financial accounts held by US. taxpayers or by foreign entities in which US. taxpayers hold a substantial ownership interest. The reporting institutions will include not only banks, but also other financial institutions, such as investment entities, brokers, and certain insurance companies.</p>
                            <p>FATCA provides special reporting requirements about the US. account holders of certain financial institutions that do not solicit business outside their country of organization and that mainly service account holders resident within it.</p>
                        </div>
                        <div className="col-sm-12 col-md-5">
                            <img src="images/fatca.jpg" alt="" width="100%" className="serviceImg heightAuto" />
                        </div>
                    </div>
