                    ...
                    <div style={{cursor:'pointer'}} className={!notification.is_read?"notification-list notification-list--unread":"notification-list" } key={index} onClick={() => { navigate('/admin/profile/'+notification.id_main) }}>
                      <div className="notification-list_content">
                        ...
                        <div className="notification-list_detail">
                          <p className="text-muted">{(notification.firstname).charAt(0).toUpperCase() + (notification.firstname).slice(1)} {(notification.lastname).charAt(0).toUpperCase() + (notification.lastname).slice(1)} has uploaded a document named {fileExtensionRemove(notification.document_name)}</p>
